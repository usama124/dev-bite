...
const PHASE1_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    "category": "json",
    "priority": "P0",
    "shortDescription": "Format valid JSON into readable indented JSON.",
    "description": "Format valid JSON into readable indented JSON. Users need to complete json formatter quickly without switching to a larger desktop application.",
    "keywords": [
      "json formatter",
